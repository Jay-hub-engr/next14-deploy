...
export default function about  () {
  return (
    <MaxWidthWrapper>
    <div 
      className="py-10 mt-4 rounded-[15%] mx-auto text-center flex flex-col items-center max-w-6xl  bg-gray-100">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          ...
          <div 
      className="py-10 rounded-[15%] mt-4 mx-auto text-center flex flex-col items-center max-w-6xl  bg-gray-100">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          Our  {''}
          <span 
          className="text-rose-600">
          ...
          <div className="py-10 rounded-[15%] mt-4 mx-auto text-center flex flex-col items-center max-w-6xl  bg-gray-100">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          What makes us {''}
          <span 
          className="text-rose-600">
